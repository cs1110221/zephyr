...
<div class="side-nav">
	<a href='profile.php?userid=<?php echo $_SESSION['userid'];?>'><p class="topbarprofiletext" title="Profile"><?php echo $_SESSION['name'];?></p></a>
			...
			title='Profile' style="width:85%;height:8%">Profile</a> 
		  </li> 
		   ...
		   <li>  <a href='home.php'><img
			...
			title='Home' style="width:85%;height:8%">Home</a> </li> 
		...
		<li>  <a href='inbox.php'><img
			...
			title='Messages' style="width:85%;height:8%">Messages</a> </li>  
			...
			title='Settings' style="width:85%;height:8%">Settings</a></li>
			...
			title='Logout' style="width:85%;height:8%">Logout</a></li>  
